...
namespace UNIFreelancerDataBaseEntry
{
    ...
    public class CommanFuction
    {
        ...
        //                    {
        //                        var dateString = (cellValue is DateTime) ? ((DateTime)cellValue).ToString("M/d/yyyy") : cellValue.ToString().Trim();
        //                        value = DateTime.ParseExact(dateString, new[] { "dd/MM/yyyy", "d/M/yyyy" }, CultureInfo.InvariantCulture, DateTimeStyles.None);
        //                    }
        //                    else
        //                    {
